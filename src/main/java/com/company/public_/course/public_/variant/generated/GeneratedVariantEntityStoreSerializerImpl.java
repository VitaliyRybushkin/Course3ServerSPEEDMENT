...
/**
 * Serializes and deserializes instances of Variant.
 * <p>
...
public abstract class GeneratedVariantEntityStoreSerializerImpl implements EntityStoreSerializer<Variant> {
    ...
    protected GeneratedVariantEntityStoreSerializerImpl(final LongFunction<ByteBuffer> bufferFinder, final LongToIntFunction offsetFinder) {
        this.bufferFinder = requireNonNull(bufferFinder);
        this.offsetFinder = requireNonNull(offsetFinder);
    }
    
    @Override
    public BiConsumer<ByteBuffer, Variant> serializer() {
    ...
    @Override
    public Class<?> deserializedType(final ColumnIdentifier<Variant> colId) {
        if (colId instanceof Variant.Identifier) {
            final Variant.Identifier _id = (Variant.Identifier) colId;
            switch (_id) {
    ...
    @Override
    public <FK_ENTITY> LongUnaryOperator finder(final ColumnIdentifier<Variant> colId, final ColumnIdentifier<FK_ENTITY> fkColId) {
        return finder(singletonList(colId), singletonList(fkColId));
    }
    
    @Override
    public <FK_ENTITY> LongUnaryOperator finder(final List<ColumnIdentifier<Variant>> cols, final List<ColumnIdentifier<FK_ENTITY>> fkCols) {
        throw new UnsupportedOperationException("Variant has no foreign references.");
    }
    ...
    @Override
    public LongPredicate isNull(final ColumnIdentifier<Variant> colId) {
        if (colId instanceof Variant.Identifier) {
            final Variant.Identifier _id = (Variant.Identifier) colId;
            switch (_id) {
                case ID   : 
                case INFO : return ALWAYS_FALSE;
                default : {
                    throw new UnsupportedOperationException(
                        String.format("Unknown enum constant '%s'.", _id)
                    );
    ...
    @Override
    public LongPredicate isPresent(final ColumnIdentifier<Variant> colId) {
        if (colId instanceof Variant.Identifier) {
            final Variant.Identifier _id = (Variant.Identifier) colId;
            switch (_id) {
                case ID   : 
                case INFO : return ALWAYS_TRUE;
                default : {
                    throw new UnsupportedOperationException(
                        String.format("Unknown enum constant '%s'.", _id)
                    );
    ...
    @Override
    public LongToByteFunction byteDeserializer(final ColumnIdentifier<Variant> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToShortFunction shortDeserializer(final ColumnIdentifier<Variant> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToIntFunction intDeserializer(final ColumnIdentifier<Variant> colId) {
    ...
    @Override
    public LongUnaryOperator longDeserializer(final ColumnIdentifier<Variant> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToFloatFunction floatDeserializer(final ColumnIdentifier<Variant> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToDoubleFunction doubleDeserializer(final ColumnIdentifier<Variant> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToCharFunction charDeserializer(final ColumnIdentifier<Variant> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToBooleanFunction booleanDeserializer(final ColumnIdentifier<Variant> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongFunction<?> objectDeserializer(final ColumnIdentifier<Variant> colId) {
        if ("info".equals(colId.getColumnId())) {
            return ref -> {
                final ByteBuffer buffer = bufferFinder.apply(ref);
                final int offset = offsetFinder.applyAsInt(ref);
                try {
    ...
    @Override
    public BiLongToIntFunction comparator(final ColumnIdentifier<Variant> colId) {
        if (colId instanceof Variant.Identifier) {
            final Variant.Identifier _id = (Variant.Identifier) colId;
            switch (_id) {
    ...
    @Override
    public BiLongToIntFunction comparatorNullsLast(final ColumnIdentifier<Variant> colId) {
        if (colId instanceof Variant.Identifier) {
            final Variant.Identifier _id = (Variant.Identifier) colId;
            switch (_id) {
                case ID   : return (aRef, bRef) -> Integer.compare(
    ...
    @Override
    public LongToIntFunction compareToByte(final ColumnIdentifier<Variant> colId, final byte value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type byte.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToShort(final ColumnIdentifier<Variant> colId, final short value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type short.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToInt(final ColumnIdentifier<Variant> colId, final int value) {
        if ("id".equals(colId.getColumnId())) {
            {
    ...
    @Override
    public LongToIntFunction compareToLong(final ColumnIdentifier<Variant> colId, final long value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type long.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToFloat(final ColumnIdentifier<Variant> colId, final float value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type float.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToDouble(final ColumnIdentifier<Variant> colId, final double value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type double.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToBoolean(final ColumnIdentifier<Variant> colId, final boolean value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type boolean.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToChar(final ColumnIdentifier<Variant> colId, final char value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type char.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToObject(final ColumnIdentifier<Variant> colId, final Object value) {
        if ("info".equals(colId.getColumnId())) {
            {
    ...
    @Override
    public LongToIntFunction compareToNull(final ColumnIdentifier<Variant> colId) {
        if (colId instanceof Variant.Identifier) {
            final Variant.Identifier _id = (Variant.Identifier) colId;
            switch (_id) {
    ...
    @Override
    public LongPredicate newPredicate(final ColumnIdentifier<Variant> colId, final EntityStorePredicate predicate) {
        if (colId instanceof Variant.Identifier) {
            final Variant.Identifier _id = (Variant.Identifier) colId;
            switch (_id) {
                case ID   : return ref -> {
    ...
    @Override
    public LongToIntFunction newCompareTo(final ColumnIdentifier<Variant> colId, final EntityStoreCompareTo compareTo) {
        if (colId instanceof Variant.Identifier) {
            final Variant.Identifier _id = (Variant.Identifier) colId;
            switch (_id) {
                case ID   : return ref -> {
    ...
    @Override
    public BiLongToIntFunction newComparator(final ColumnIdentifier<Variant> colId, final EntityStoreComparator comparator) {
        if (colId instanceof Variant.Identifier) {
            final Variant.Identifier _id = (Variant.Identifier) colId;
            switch (_id) {
    ...
    public LongToIntFunction sizeOf() {
        return ref -> VARSIZE_BEGINS + Math.abs(bufferFinder.apply(ref).getInt(offsetFinder.applyAsInt(ref) + ENDPOS_INFO));
    }
}